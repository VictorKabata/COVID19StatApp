...
class CountriesViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
    ...
    var textViewPer1MillionUnfolded: TextView? = null
    ...
    init {
        ...
        this.textViewActiveCasesUnfolded = itemView.findViewById(R.id.textView_active_cases_details)
        this.textViewCriticalCasesUnfolded = itemView.findViewById(R.id.textView_critical_details)
        this.textViewCasesTodayUnfolded = itemView.findViewById(R.id.textView_today_cases_details)
        this.textViewDeathTodayUnfolded = itemView.findViewById(R.id.textView_today_death_details)
        this.textViewPer1MillionUnfolded =
            itemView.findViewById(R.id.textView_case_per1Million_details)
    ...
    fun initialize(data: CountriesCoronaDataEntry) {
        ...
        textViewPer1MillionUnfolded?.text = data.casesPerOneMillion.toString()
